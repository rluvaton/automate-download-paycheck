...
import {getFirstPage, getOptionsAndSelected, selectValue, setupDownloadLocation} from "./puppeteer-utils";

import {hilan} from "./conf";

import {sleep} from "./general-utils";

import {isValidPdfFile} from "./pdf-service";
 ...
 */
export async function downloadPaycheckFor(date, folderToDownloadPaycheckTo, browser) {
